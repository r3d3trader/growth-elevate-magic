...
const Hero: React.FC<HeroProps> = ({
  ...
  return <section className="relative bg-gradient-to-b from-agency-blue-50 to-white overflow-hidden pt-20 pb-16 md:pt-28 md:pb-24">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          <motion.div className="flex-1 max-w-2xl" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
            ...
            <div className="bg-white rounded-xl shadow-custom p-6 lg:p-8 shadow-custom-hover">
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                <div>
                  ...
                  <input type="email" id="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@email.com" required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-agency-blue focus:border-agency-blue transition-colors" />
                </div>
                
                <button type="submit" className={cn("w-full bg-gradient-to-r from-agency-blue to-agency-indigo text-white py-3 px-6 rounded-lg font-medium", "transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-agency-blue/20")}>
        ...
        <div className="mt-16">
          <motion.div className="py-4 px-6 bg-white bg-opacity-80 backdrop-blur-sm rounded-xl shadow-md flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: 0.4
            ...
            <div className="flex items-center justify-center gap-8">
              ...
              <div className="flex items-center gap-6">
                {[1, 2, 3].map(logo => <div key={logo} className="h-8 w-16 bg-gray-200 rounded-md flex items-center justify-center text-xs text-gray-600">
                    Logo {logo}
                  </div>)}
              </div>
            </div>
